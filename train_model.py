...
def main():
    ...
    for team_str in teams_str:
        ...
        new_team_weights = trainTeam(training_inputs, training_outputs, syn_weights, acceptable_accuracy=80)
...
def trainTeam(training_inputs, training_outputs, weights, acceptable_accuracy=85):
    ...
    iterations = 0
    syn_weights = weights
    widgets = [Bar(marker='=',left='[',right=']'), ' ', Percentage()]
    ...
    while(accuracy < acceptable_accuracy):
        ...
        progress_bar.update(int(accuracy))
    progress_bar.finish()
